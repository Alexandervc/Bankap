        ...
        cbSelectBank1.valueProperty().addListener(new ChangeListener() {
            ...
            public void changed(ObservableValue ov, Object t, Object t1) {
                ...
                if (application.startBalie(bankNaam)) {
                    taMessage.setText(taMessage.getText() + System.lineSeparator() + bankNaam + " bank is online");
                } else {
                    taMessage.setText(taMessage.getText() + System.lineSeparator() + "Connection Failed");
                }
            }
        }
        );
